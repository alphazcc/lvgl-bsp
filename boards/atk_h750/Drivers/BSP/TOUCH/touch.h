...
#define T_CS_GPIO_PIN                   SYS_GPIO_PIN5
#define T_CS_GPIO_CLK_ENABLE()          do{ RCC->AHB4ENR |= 1 << 2; }while(0)   /* 所在IO口时钟使能 */

#define T_MISO_GPIO_PORT                GPIOD
#define T_MISO_GPIO_PIN                 SYS_GPIO_PIN6
#define T_MISO_GPIO_CLK_ENABLE()        do{ RCC->AHB4ENR |= 1 << 3; }while(0)   /* 所在IO口时钟使能 */
